      ...
      <View style={styles.topBarContainer}>
        <View style={styles.cartInfoContainerTopBar}>
          ...
          <View style={styles.cartInfoTopBar}>
            <Text style={styles.primaryText}>My Cart</Text>
            <Text style={styles.primaryText2}>{cartproduct.length} Items</Text>
          </View>
        </View>
      ...
      <View style={styles.cartBottomContainer}>
        <View style={styles.cartBottomLeftContainer}>
          ...
          <View>
            ...
            <Text style={styles.cartBottomSecondaryText}>₱ {totalPrice} <Text style={styles.primaryText2}>PHP</Text></Text>
